...
mod tests {
    ...
    fn fancy_headings() {
        let cases: Vec<(&str, &str)> = vec![
            (
                "## Hello world",
                "<h2 id=\"hello-world\" x-data=\"{ open: false }\" @mouseover=\"open = true\" @mouseout=\"open = false\">Hello world<a href=\"#hello-world\" x-show=\"open\">#</a></h2>\n",
            ),
            (
                "### A heading with some `code`",
                "<h3 id=\"a-heading-with-some-code\" x-data=\"{ open: false }\" @mouseover=\"open = true\" @mouseout=\"open = false\">A heading with some <code>code</code><a href=\"#a-heading-with-some-code\" x-show=\"open\">#</a></h3>\n",
            ),
        ];
